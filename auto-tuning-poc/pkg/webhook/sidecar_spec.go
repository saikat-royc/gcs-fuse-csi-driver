...
const (
	...
	// POC placeholder emptyDirs. CSI will make a lazy decision based on bucket shape and target node allocatables on which file cache to surface to gcsfuse
	SidecarContainerCacheRamDiskVolumeName       = "gke-gcsfuse-file-cache-ram-disk"
	SidecarContainerCacheRamDiskVolumeMountPath  = "/gcsfuse-file-cache-ram-disk"
	SidecarContainerCacheEphemeralDiskVolumeName = "gke-gcsfuse-file-cache-ephemeral-disk"
	SidecarContainerCacheEphemeralDiskMountPath  = "/gcsfuse-file-cache-ephemeral-disk"
...
var (
	...
	cacheRamDiskVolume = corev1.Volume{
		Name: SidecarContainerCacheRamDiskVolumeName,
		VolumeSource: corev1.VolumeSource{
			EmptyDir: &corev1.EmptyDirVolumeSource{
	...
	cacheEphemeralDiskVolume = corev1.Volume{
		Name: SidecarContainerCacheEphemeralDiskVolumeName,
		VolumeSource: corev1.VolumeSource{
			EmptyDir: &corev1.EmptyDirVolumeSource{},
		},
	}
	...
	cacheRamDiskVolumeMount = corev1.VolumeMount{
		Name:      SidecarContainerCacheRamDiskVolumeName,
		MountPath: SidecarContainerCacheRamDiskVolumeMountPath,
	}

	cacheEphemeralDiskVolumeMount = corev1.VolumeMount{
		Name:      SidecarContainerCacheEphemeralDiskVolumeName,
		MountPath: SidecarContainerCacheEphemeralDiskMountPath,
	}
)
...
func GetSidecarContainerSpec(c *Config) corev1.Container {
	...
	volumeMounts := []corev1.VolumeMount{TmpVolumeMount, buffVolumeMount, cacheVolumeMount, cacheRamDiskVolumeMount, cacheEphemeralDiskVolumeMount}
...
func GetSidecarContainerVolumeSpec(existingVolumes ...corev1.Volume) []corev1.Volume {
	...
	var cacheEphemeralDiskVolumeExists, cacheRamDiskVolumeExists bool
	...
	for _, v := range existingVolumes {
		...
		case SidecarContainerCacheRamDiskVolumeName:
			cacheRamDiskVolumeExists = true
		case SidecarContainerCacheEphemeralDiskVolumeName:
			cacheEphemeralDiskVolumeExists = true
		}
	}
	...
	if !cacheRamDiskVolumeExists {
		volumes = append(volumes, cacheRamDiskVolume)
	}
	if !cacheEphemeralDiskVolumeExists {
		volumes = append(volumes, cacheEphemeralDiskVolume)
	}
	return volumes
}
